...
a population-level compaction law. At the measured {{depth_grid_spacing_measured_m}} m sampling
interval of this dataset, a 512-token context spans roughly {{context_window_m:.1f}} m of
